...
var y;
var t = s.length - 1; 
if(document.getElementById("e").value.search("end()") == -1){
alert("end() not found");
break;}
for(y=0;y<=t;y++){
...
case 0:
	...
	obstruction = true;
	setTimeout(function(){ 
	document.getElementById("environment").rows[r_initial].cells[t_initial].style.background = "yellow";}, q * 1000 + 2000);
	alert("Obstruction");
	break;
